...
def thread_task(lock):
    for _ in range(1000000):
        lock.acquire() #Yêu cầu lock bằng cách gọi phương thức lock.acquire increment() 
        increment()  #Tăng giá trị của x bằng cách gọi phương thức 
        lock.release() #Giải phóng lock bằng cách gọi phương thức 
...
if __name__ == "__main__":#Kiểm tra module đang được chạy là module chính  #hay không. 
        for i in range(10): # Vòng lặp for chạy 10 lần 
            main_task() 
            # Mỗi lần lặp main_task() được gọi
